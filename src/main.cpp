...
uint256 hashGenesisBlock("0x68bbd031f83fdbc9f7c132e6942c3d4c852bc413b9a337c8ae14c8e72800e75f");
...
const string strMessageMagic = "muflocoin Signed Message:\n";
...
static const int64 nTargetTimespan = 7 * 24 * 60 * 60; // muflocoin: 7 days
static const int64 nTargetSpacing = 5; // muflocoin: 5 seconds blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal muflocoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "muflocoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x8d5a99f08448a0c26741b17b2fe00f889a68c791b3e28b4e0df89831a5cf471d");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Building a coin for fun ...";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1387814635; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 3191226;

        if (fTestNet)
        {
            block.nTime    = 1387809203;
            block.nNonce   = 1743748;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x55f1917ac63bb860bd6cf024efed61bf240bc657dbcdc24a430f88d11139b808"));
