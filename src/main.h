...
static const int64 MAX_MONEY = 6307200000 * COIN; // maximum number of coins
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > COIN * 1728 / 250; // 5760 blocks found a day. Priority cutoff is 1 MFC day / 250 bytes.
    }
